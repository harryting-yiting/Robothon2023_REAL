...
#-------------------------------Tasks--------------------------------#  
    ...
    def task_open_door(self):
        ...
        self.default_hight = tmToXyzRA(moveAbove(moveForward, 0.05))[2]
        return
    ...
    def task_pull_probe_insert_wrap(self):
        self.task_pull_pen()
    ...
    def run(self, board_base_TRPY):
        ...
        self.task_open_door()
        self.task_pull_probe_insert_wrap()
